    ...
    try {
        ...
        if (user) {
            ...
            await tranEmailApi.sendTransacEmail({
                ...
                htmlContent:`<h1>Expense Tracker App</h1><p>Hi there! Reset the Expense Tracker APP password for your account with email</p><a href="http://localhost:3000/password/resetpassword/{{params.role}}">Reset Password</a><hr><hr><p>If reset password is not requested by you then contact us Immediately at website</p>`,
                params:{
                    role:id
                }
            })
                ...
                <body >
                    <div class="container p-2">
                        <div class="card-body w-50 m-auto">
                            ...
                            <form action="http://localhost:3000/password/updatepassword/${id}" onsubmit="formsubmitted(e)" method="get" class="form-control bg-dark text-white mb-2">
                            ...
                            <ul class="text-center border-0 p-0 m-1">
                                <li style="list-style-type: none;margin-bottom: 3px;"><a href="../views//signup.html">New User-Sign Up</a></li>
                                <li style="list-style-type: none;"><a href="../views/login.html">Exisiting User-Login</a></li>
                            </ul>
                        </div>
                    </div>
                    <script>
